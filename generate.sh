...
readonly JAVASCRIPTS_DIR="$SCRIPT_ROOT/javascripts"
readonly STYLESHEETS_DIR="$SCRIPT_ROOT/stylesheets"
input_github=
output_directory=
markdown_path=
clear_output=false
...
yes | cp -rf "$JAVASCRIPTS_DIR" "$output_directory"
yes | cp -rf "$STYLESHEETS_DIR" "$output_directory"
...
echo "      <p class=\"view\"><a href=\"http://github.com/$github_username/$github_repository\">View the Project on GitHub <small>$github_username/$github_repository</small></a></p>"
echo "      <ul>"
...
echo "        <li><a href=\"http://github.com/$github_username/$github_repository\">Fork On <strong>GitHub</strong></a></li>"
echo "      </ul>"
echo "    </header>"
echo "    <section>"
...
echo "    </section>"
echo "    <footer>"
echo "      <p><button class=\"material-icons\" title=\"Toggle dark mode\" onclick=\"toggleDark()\"></button></p>"
echo "      <p>This project is maintained by <a href=\"http://github.com/$github_username\">$github_fullname</a></p>"
